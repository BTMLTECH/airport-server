...
// =======================================================
// SEND FEEDBACK REMINDERS 6 HOURS AFTER FLIGHT
// Applies to: Paid + Free Requests
// =======================================================
cron.schedule("*/20 * * * *", async () => {
  ...
  for (const booking of bookings) {
    ...
    const flightDT = moment.utc(`${booking.flightDate} ${booking.flightTime}`, "YYYY-MM-DD HH:mm");
    const sixHoursAfter = flightDT.clone().add(6, "hours");
    ...
    if (now.isSameOrAfter(sixHoursAfter)) {
      ...
      try {
        ...
        // Optionally log the error to FailedEmail
      }
    }
  }
});
...
// =======================================================
// SEND FLIGHT REMINDERS 6 HOURS BEFORE FLIGHT
// Applies to: Paid + Free Requests
// =======================================================
