...
export interface ServiceOption {
  type: string;
  priceRange: string;       // Original NGN string
  priceRangeUSD?: string;   // New USD string
}
...
// ============================
// 🧩 Subschema for service options
// ============================
const ServiceOptionSchema = new Schema<ServiceOption>(
  {
    type: { type: String, required: true },
    priceRange: { type: String, required: true },
    priceRangeUSD: { type: String, required: false },
  },
  { _id: false }
);
...
const SelectedServiceDetailSchema = new Schema<SelectedServiceDetail>(
  {
    ...
    price: { type: Number, required: false },
    dollar: { type: Number, required: false },
    options: { type: [ServiceOptionSchema], required: false },
    selectedFlight: { type: String, required: false },
    serviceType: { type: String, enum: ["online", "offline"], required: false },
  },
  { _id: false }
);
